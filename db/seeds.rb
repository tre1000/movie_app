...
# Movie.create(title: "Goodfellas", year: 1990, plot: "The story of Henry Hill and his life in the mob, covering his relationship with his wife Karen Hill and his mob partners Jimmy Conway and Tommy DeVito in the Italian-American crime syndicate.")

# Movie.create(title: "American Psycho", year: 2000, plot: "A wealthy New York City investment banking executive, Patrick Bateman, hides his alternate psychopathic ego from his co-workers and friends as he delves deeper into his violent, hedonistic fantasies.")

# Movie.create(title: "Oldboy", year: 2003, plot: "After being kidnapped and imprisoned for fifteen years, Oh Dae-Su is released, only to find that he must find his captor in five days.")
Actor.create!([
  { first_name: "Jack", last_name: "Black", known_for: "High Fidelity", gender: nil, age: 50, movie_id: 6 },
  { first_name: "Britt", last_name: "Kuhic", known_for: "The American Men from the Black Lagoon", gender: nil, age: 29, movie_id: 6 },
...
#   {title: "Pulp Fiction", year: 1994, plot: "The lives of two mob hitmen, a boxer, a gangster and his wife, and a pair of diner bandits intertwine in four tales of violence and redemption.", director: nil, english: true},
